...
from src.gatr_v111_onnx.layers.attention.attention import GeometricAttention
from src.gatr_v111_onnx.layers.attention.config import SelfAttentionConfig
from src.gatr_v111_onnx.layers.attention.positional_encoding import ApplyRotaryPositionalEncoding
from src.gatr_v111_onnx.layers.attention.qkv import MultiQueryQKVModule, QKVModule
from src.gatr_v111_onnx.layers.dropout import GradeDropout
...
class SelfAttention(nn.Module):
    ...
    def __init__(self,  basis_q, basis_k, basis_pin,config: SelfAttentionConfig) -> None:
        ...
        # QKV computation
        # print("config.multi_query ",config.multi_query )
        self.qkv_module = MultiQueryQKVModule(self.basis_pin,config) 
        #if config.multi_query else QKVModule(self.basis_pin, config)
