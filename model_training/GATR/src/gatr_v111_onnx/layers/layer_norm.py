...
from src.gatr_v111_onnx.primitives.normalization import equi_layer_norm
...
class EquiLayerNorm(nn.Module):
    ...
    def __init__(self, gp_mask, mv_channel_dim=-2, scalar_channel_dim=-1, epsilon: float = 0.01):
        super().__init__()
