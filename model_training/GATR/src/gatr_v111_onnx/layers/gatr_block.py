...
from src.gatr_v111_onnx.layers import SelfAttention, SelfAttentionConfig
from src.gatr_v111_onnx.layers.layer_norm import EquiLayerNorm
from src.gatr_v111_onnx.layers.mlp.config import MLPConfig
from src.gatr_v111_onnx.layers.mlp.mlp import GeoMLP
...
class GATrBlock(nn.Module):
    ...
    def __init__(
        ...
        self.outer = outer
        self.norm = EquiLayerNorm(gp_mask)
        self.norm2 = EquiLayerNorm(gp_mask)
